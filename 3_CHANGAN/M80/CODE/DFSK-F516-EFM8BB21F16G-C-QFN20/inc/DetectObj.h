...
/* Driver */
#define	    DRIVE_PORT_1	 P1_B5
#define	    DRIVE_PORT_2	 P1_B6
...
#define	DETECT_DELAY_UPDATE_HIGH		        1000//500//1200	/* Unit: ms */
#define DETECT_DELAY_UPDATE_MID			        1000//500//800     /* Unit: ms */
#define DETECT_DELAY_UPDATE_LOW			        1000//500//500     /* Unit: ms */
...
#define RING_TIME_RECOVER_VALUE					1300	/* Unit: us */
...
#define	SN_DISTANCE_NULL                      	150		/* Unit: cm */
#define	SN_DISTANCE_RL                      	150		/* Unit: cm */
#define SN_DISTANCE_RML                     	150     /* Unit: cm */
#define	SN_DISTANCE_RMR                     	150		/* Unit: cm */
#define	SN_DISTANCE_RR                      	80		/* Unit: cm */
#define	SN_DISTANCE_FL                      	80		/* Unit: cm */
#define	SN_DISTANCE_FR                      	80		/* Unit: cm */

#define	SN_DISTANCE_5Snr_NULL                      	150		/* Unit: cm */
#define	SN_DISTANCE_5Snr_RL                      	150		/* Unit: cm */
...
#define	SN_DISTANCE_3Snr_NULL                      	150		/* Unit: cm */
#define	SN_DISTANCE_3Snr_RL                      	150		/* Unit: cm */
...
extern const BYTE	EachSNMaxDistance_5Snr[SN_NUM];
extern const BYTE	EachSNMaxDistance_3Snr[SN_NUM];
extern const BYTE	EachSNMaxDistance_2Snr[SN_NUM];
