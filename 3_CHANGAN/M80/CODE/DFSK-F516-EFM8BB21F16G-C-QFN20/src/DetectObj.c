...
const BYTE	EachSNMaxDistance_5Snr[SN_NUM] =
{
  SN_DISTANCE_5Snr_NULL,
  SN_DISTANCE_5Snr_RL,
  SN_DISTANCE_5Snr_RML,
  SN_DISTANCE_5Snr_RR,
  SN_DISTANCE_5Snr_FL,
  SN_DISTANCE_5Snr_FR,
};
const BYTE	EachSNMaxDistance_3Snr[SN_NUM] =
{
  SN_DISTANCE_3Snr_NULL,
  SN_DISTANCE_3Snr_RL,
  SN_DISTANCE_3Snr_RML,
  SN_DISTANCE_3Snr_RR,
  SN_DISTANCE_3Snr_FL,
  SN_DISTANCE_3Snr_FR,
};
const BYTE  EachSNMaxDistance_2Snr[SN_NUM] =
{
	SN_DISTANCE_2Snr_RL,
	SN_DISTANCE_2Snr_RML,
};
