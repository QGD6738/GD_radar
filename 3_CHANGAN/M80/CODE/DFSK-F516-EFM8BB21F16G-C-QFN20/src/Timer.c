...
void Time_Init1msTimer(void) //use time 2
{
	...
	TMR2L			= 0xFF;
	TMR2H			= 0xFF;
	TMR2RLL			= (BYTE)((0xFFFF-4083)>>0);	//Set reload value(1000us ：cnt = 1000/12*49 = 4083)
...
void Time_InitAdcTriggerTimer(void) //time 3
{
	...
	TMR3L	= 0xFF;
	TMR3H	= 0xFF;
	TMR3RLL	= (BYTE)((0xFFFF-((COUNT_TIME_UNIT*49)/12))>>0);	//Set reload value(35us ：cnt = 35/12*49 = 142)
