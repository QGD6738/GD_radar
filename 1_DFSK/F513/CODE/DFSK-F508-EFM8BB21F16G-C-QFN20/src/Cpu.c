...
void Cpu_InitHardwarePort(void)
{
	...
	P0	    = 0xED; //P0.0 is adc VDD_REF; 		 P0.1 is GND_REF;           P0.2 is ID_IN;     P0.3 is ID_TX;
					//P0.4 is UART0_TX/DATA_TX;  P0.5 is UART0 RX/DATA_RX;  P0.6 is ECHO;      P0.7 is NULL;
	P0MDOUT	=  P0MDOUT_B0__OPEN_DRAIN | P0MDOUT_B1__OPEN_DRAIN | P0MDOUT_B2__OPEN_DRAIN | P0MDOUT_B3__OPEN_DRAIN
			 | P0MDOUT_B4__PUSH_PULL  | P0MDOUT_B5__OPEN_DRAIN | P0MDOUT_B6__OPEN_DRAIN | P0MDOUT_B7__OPEN_DRAIN;
	P0MDIN 	=  P0MDIN_B0__ANALOG  | P0MDIN_B1__ANALOG  | P0MDIN_B2__ANALOG  | P0MDIN_B3__ANALOG
			 | P0MDIN_B4__DIGITAL | P0MDIN_B5__DIGITAL | P0MDIN_B6__ANALOG | P0MDIN_B7__DIGITAL;
	...
	P1	    = 0x40;//P1.0 is NULL;     P1.1 is NULL;  P1.2 is NULL;      P1.3 is DRIVE_L;
				   //P1.4 is DRIVE_H;  P1.5 is NULL;  P1.6 is POWER_AD;
	P1MDOUT = P1MDOUT_B0__OPEN_DRAIN | P1MDOUT_B1__OPEN_DRAIN | P1MDOUT_B2__OPEN_DRAIN | P1MDOUT_B3__PUSH_PULL
			| P1MDOUT_B4__PUSH_PULL | P1MDOUT_B5__OPEN_DRAIN  | P1MDOUT_B6__OPEN_DRAIN  | P1MDOUT_B7__PUSH_PULL;
	P1MDIN =  P1MDIN_B0__DIGITAL | P1MDIN_B1__DIGITAL | P1MDIN_B2__DIGITAL | P1MDIN_B3__DIGITAL
			| P1MDIN_B4__DIGITAL | P1MDIN_B5__DIGITAL | P1MDIN_B6__ANALOG  | P1MDIN_B7__DIGITAL;
