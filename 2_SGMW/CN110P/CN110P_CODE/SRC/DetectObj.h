...
#define	CONTINUOUS_CHIME_DISTANCE           	        30	/* Unit: cm */
...
#define DETECT_NOISE_BASE_VOL                           8       /* Ad value */        
